...
class DetailFavItemFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val tipo = arguments?.getString("tipo") ?: "Sin tipo"
        val origen = arguments?.getString("origen") ?: "Sin origen"
        ...
        binding.fabAddComment.setOnClickListener {
            ...
            if (comentario.isNotEmpty()) {
                ...
                val comentarioFormateado = "Comentario $nuevoContador: $comentario"
        ...
        binding.btnBorrarComentarios.setOnClickListener {
            ...
            Toast.makeText(requireContext(), "Comentarios borrados", Toast.LENGTH_SHORT).show()
        }
    }
