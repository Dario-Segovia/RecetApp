...
class ItemListFragment : Fragment() {
    ...
    private fun initRecyclerView() {
        ...
        // Asegúrate de pasar el contexto al llamar a getListaRecetas()
        binding.recyclerRecetas.adapter = RecetasAdapter(
            RecetasProvider.getListaRecetas(requireContext()), // Usamos requireContext() para obtener el contexto
    ...
    private fun onFavoriteSelected(receta: RecetasItem) {
        ...
        Toast.makeText(context, getString(R.string.anadido_favoritos, receta.nombre), Toast.LENGTH_SHORT).show()
    }
