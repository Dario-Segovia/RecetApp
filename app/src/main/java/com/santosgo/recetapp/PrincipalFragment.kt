...
class PrincipalFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Configurar el menú con el controlador de navegación
        navController?.let {
            binding.barramenu.setupWithNavController(it)
        }

        // Cambiar el texto de los botones o títulos según los valores de strings.xml
        ...
        nombreUsuario = sharedPreferences.getString("username", getString(R.string.default_user))
